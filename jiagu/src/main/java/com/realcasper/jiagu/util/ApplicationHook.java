package com.realcasper.jiagu.util;
...
public class ApplicationHook {
    ...
    public static void hook(Application application, String delegateApplicationName) {
        if (TextUtils.isEmpty(delegateApplicationName) || "com.realcasper.jiagu.StubApp".equals(delegateApplicationName)) {
    ...
    public static void replaceApplicationContext(Application application) {
        if (sDelegateApplication == null || "com.realcasper.jiagu.StubApp".equals(sDelegateApplication.getClass().getName())) {
            return;
        }
